...
public class Game {
    ...
    public Game() {
        ...
        // Création d'énigmes
        Puzzle p1 = new Puzzle("EnigmeAissya","Le plat","Quel est le plat préféré de Aissya ? : \n - Lablabi \n - Sushi \n - Fricassé" ,"Lablabi", new Key("cleAissya", "Cette clé permet d'ouvrir la zone Gabwaaay Bay", "Gabwaaay Bay"),player);
        ...
        Puzzle p10 = new Puzzle("EnigmeCarla","","Quels sont les origines de Carla ? : \n - Maroc & Guadloupe \n - Liban & Jamaique \n - Vietnam & Bresil" ,"Liban & Jamaique", new Key("cleCarla", "Cette clé permet d'ouvrir la zone ??", "??"),player);
